...
def login():
  url ="https://pastebin.com/raw/zVR42Vam"
...
os.system("cls||clear")
print(red + banner)
print(f"   {red}[ {white} CXT4X  SINCE 2019,, THANKS FOR USE THIS TOOL, GOOD LUCK ALL{red} ]")
print(f"                  {red}[ {white}SCRIPT BUSSID VIP V1.0-Release{red} ]\n")
print(f"============================================================================")
print(f"")
...
print(red + banner)
print(f"   {red}[ {white} CXT4C  SINCE 2019,, THANKS FOR USE THIS TOOL, GOOD LUCK ALL{red} ]")
